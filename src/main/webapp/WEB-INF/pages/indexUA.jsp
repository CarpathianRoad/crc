...
<html lang="en">
            ...
            <div class="sub-header">
				<div class="menu-block">
					<div class="closed-menu">
						...
						<img class="menu-button" src="images/menu-icon.png" />
					</div>
                ...
                <div class="logo-block">
                    <a class="brand"><img src="images/main-logo.png" /></a>
                </div>
            </div>
	</header>
	<a class="nav-arrow smooth-link" href="#energy"><img src="images/arrow.png" /></a>
	<main role="main">
		<section id="energy">
		...
		<section id="ecology">
			<div class="main-block">
				<div class="main-header-block">
					<img src="images/icon-ecology.png" />
					<h4>Екологія</h4>
				</div>
				<div class="side-block left-block">
					<div class="image-block">
						<img src="images/bg-ecology.png"/>
					</div>
				</div>
				<div class="side-block right-block">
					<div class="text-block">
		...
		<section id="tourism">
			<div class="main-block">
				<div class="main-header-block">
					<img src="images/icon-tourism.png" />
					<h4>Туризм</h4>
				</div>
				<div class="side-block left-block">
					<div class="text-block">
						...
						Ми відкриті для співпраці з активними туристичними суб’єктами та органами місцевої влади для реалізації корисних  ініціатив та проектів у сфері туризму, який має значний потенціал, щоб стати пріоритетною галуззю для розвитку регіону.
                                            ...
                                            <a href="http://www.carpathianroad.com/" target="_blank" class="descr-button">Детальніше</a>
					</div>
				</div>
				<div class="side-block right-block">
					<div class="image-block">
						<a href="http://www.carpathianroad.com/ target="_blank"><img src="images/bg-tourism.png"/></a>
					</div>
				</div>
			</div>
		</section>
		<section id="soc-projects">
			<div class="main-block">
				<div class="main-header-block">
					<img src="images/icon-soc-projects.png" />
					<h4>Соцпроекти</h4>
				</div>
				<div class="side-block left-block">
					<div class="image-block">
						<img src="images/bg-soc-projects.png"/>
					</div>
				</div>
				<div class="side-block right-block">
					<div class="text-block">
	...
	реалізації цікавих, інноваційних та суспільно-значущих проектів.
					...
					<p>
					-  Збору і розповсюдження інформації про найкращий досвід ЄС у розробці і реалізації стратегій (програм) соціально-економічної політики, регіонального, місцевого розвитку та реалізації транскордонних проектів.
					</p>
				</div>	
				</div>
